...
export default function UserBlogCreate({params}) {
    ...
    const handleSubmit = async(e) => {
        try {
            const response = await fetch(`${process.env.API}/blog/user/${id}`, {
                method: "PUT",
                headers: {
        ...
        <div className="container mb-5">
            <div className="row">
                <div className="col">
                    ...
                    {image && <img src={image} alt="preview image" style={{width: "100px"}}/>}

                    <div className="d-flex justify-content-between mt-3">
                        <button className="btn btn-outline-secondary">
                            <label className="mt-2 pointer" htmlFor="upload-button">{loading ? "Uploading..." : "Upload image"}</label>
